                    ...
                    <ul class="list-unstyled topbar-nav float-end mb-0">  
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i data-feather="power" class="align-self-center icon-xs icon-dual me-1"></i>Se deconnecter</a>
