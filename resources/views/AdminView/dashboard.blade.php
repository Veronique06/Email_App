                 ...
                 <div class="card-body">
                     <ul class="list-group custom-list-group mb-n3">
                         <li class="list-group-item align-items-center d-flex justify-content-between pt-0">
                             <div class="media">
                                 <img src="{{ asset('assets/images/small/rgb.svg')}}" height="30"
                         ...
                         <li class="list-group-item align-items-center d-flex justify-content-between">
                             <div class="media">
                                 <img src="{{ asset('assets/images/small/cobweb.svg')}}" height="30"
                                     class="me-3 align-self-center rounded" alt="...">
                                 <div class="media-body align-self-center">
                         ...
                         <li class="list-group-item align-items-center d-flex justify-content-between">
                             <div class="media">
                                 <img src="{{ asset('assets/images/small/blocks.svg')}}" height="30"
                                     class="me-3 align-self-center rounded" alt="...">
                                 <div class="media-body align-self-center">
                         ...
                         <li class="list-group-item align-items-center d-flex justify-content-between">
                             <div class="media">
                                 <img src="{{ asset('assets/images/small/atom.svg')}}" height="30"
                                     class="me-3 align-self-center rounded" alt="...">
                                 <div class="media-body align-self-center">
                                 ...
                                 <div class="activity-info-text">
                                     <div class="d-flex justify-content-between align-items-center">
                                         <p class="text-muted mb-0 font-13 w-75"><span>Donald</span>
                                             updated the status of <a href="#">Refund #1234</a> to awaiting customer
                                             response
                                         </p>
                 ...
                 <div class="card-body">
                     <div class="table-responsive browser_users">
                         <table class="table mb-0">
                             ...
                             <tbody>
                                 <tr>
                                     <td><img src="{{ asset(' assets/images/browser_logo/chrome.png')}}" alt=""
                                 ...
                                 <!--end tr-->
                                 <tr>
                                     <td><img src="{{ asset('assets/images/browser_logo/micro-edge.png')}}" alt=""
                                 ...
                                 <!--end tr-->
                                 <tr>
                                     <td><img src="{{ asset('assets/images/browser_logo/in-explorer.png')}}  " alt=""
                                 ...
                                 <!--end tr-->
                                 <tr>
                                     <td><img src="{{ asset('assets/images/browser_logo/opera.png')}}  " alt=""
