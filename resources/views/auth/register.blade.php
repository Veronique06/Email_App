                                            ...
                                            <form class="form-horizontal " method="post" action="{{route('register')}}">
                                                ...
                                                <div class="form-group mb-2">
                                                 ...
                                                 <div class="form-group mb-2">
                                                    ...
                                                    <div class="input-group">                                                                                         
                                                        <input type="text" class="form-control" name="prenom" id="username" placeholder="">
                                                    </div>
                                                    @error('prenom')
                                                        <span class="text-danger">{{$message}}</span>
                                                    @enderror                                    
                                                ...
                                                <div class="form-group mb-0 row">
                                                    <div class="col-12">
                                                        <button class="btn btn-primary w-100 waves-effect waves-light" type="submit">S'inscrire <i class="fas fa-sign-in-alt ms-1"></i></button>
                                                    </div><!--end col--> 
                                                </div> <!--end form-group-->                           
                                            </form><!--end form-->
